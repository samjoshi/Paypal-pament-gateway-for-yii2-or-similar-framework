...
class paypal_class {
    ...
    var $ipn_log = true;                    // bool: log IPN results to text file?
    var $ipn_log_file = '.ipn_results.log';             // filename of the IPN log
    ...
    function submit_paypal_post() {
        ...
        echo "<center><br/>If you are not automatically redirected to ";
        echo "paypal within 5 seconds...<br/><br/>\n";
        echo "<input type=\"submit\" value=\"Click Here\" class=\"btn btn-primary btn-uniform\"></center><br/>\n";
